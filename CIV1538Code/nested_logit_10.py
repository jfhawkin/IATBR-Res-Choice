...
def logit_utils(params, const):
    if const == 0:
        ...
        V_PT = beta_dict['COST'] * df['PT_Fare'] + beta_dict['TIME'] * df['PT_IVTT'] \
            ...
            + beta_dict['ASC_PT']
        V_PR = beta_dict['TIME'] * df['PR_HT_IVTT'] + beta_dict['TIME'] * df['PR_HT_IVTT'] \
...
def logit_prob(params, const):
    ...
    PUD = PUN_AD + PUN_CP + PUN_PT + PUN_PR + PUN_CR + PUN_C + PUN_W
